...
CREATE TABLE IF NOT EXISTS INVOICE.USERS (
  ...
  LAST_LOGGED TIMESTAMP    NOT NULL DEFAULT SYSTIMESTAMP,
...
INSERT INTO INVOICE.USERS (USER_ID, USERNAME, FIRST_NAME, LAST_NAME, MIDDLE_NAME, LAST_LOGGED, ENABLED)
VALUES (1, 'bcavlin', 'Branislav', 'Cavlin', '', SYSTIMESTAMP, 1);
