...
FROM (
       SELECT
         ...
         TO.ADDRESS_LINE_1 || ' ' || TO.ADDRESS_LINE2   AS TO_ADDRESS,
         TO.PHONE1                                     AS TO_PHONE,
         CFR.COMPANY_NAME                              AS FROM_NAME,
         CFR.ADDRESS_LINE_1 || ' ' || CFR.ADDRESS_LINE2 AS FROM_ADDRESS,
  ...
  LEFT JOIN INVOICE.TIMESHEET TS ON II.INVOICE_ITEM_ID = TS.INVOICE_ITEM_ID;
