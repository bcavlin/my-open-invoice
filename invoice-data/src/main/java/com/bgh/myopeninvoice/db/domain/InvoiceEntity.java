...
public class InvoiceEntity implements java.io.Serializable {
    ...
    private CompanyEntity companyByCompanyTo;

    @ManyToOne
    @JoinColumn(name = "COMPANY_CONTACT_FROM", referencedColumnName = "COMPANY_CONTACT_ID", nullable = false,
            insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "COMPANY_CONTRACT_TO", referencedColumnName = "CONTRACT_ID", nullable = false,
            insertable = false, updatable = false)
