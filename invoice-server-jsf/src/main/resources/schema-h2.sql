...
ALTER TABLE INVOICE.INVOICE
  ADD FOREIGN KEY (COMPANY_CONTRACT_TO) REFERENCES INVOICE.CONTRACTS (CONTRACT_ID);
--to be added second after previous statement
ALTER TABLE INVOICE.INVOICE ALTER COLUMN COMPANY_CONTRACT_TO INT NOT NULL;

--new from 0.2.0
CREATE SEQUENCE INVOICE.CONTRACT_COUNTER_SEQ START WITH 4 INCREMENT BY 2;