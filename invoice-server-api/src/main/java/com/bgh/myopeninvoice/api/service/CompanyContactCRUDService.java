...
@Slf4j
@Service
public class CompanyContactCRUDService implements CommonCRUDService<CompanyContactEntity> {
  ...
  @Override
  public void validate(CompanyContactEntity entity, Action action) throws InvalidDataException {
  }
