...
public interface InvoiceAPI {
  ...
  ResponseEntity<DefaultResponse<InvoiceDTO>> findAll(
  ...
  ResponseEntity<DefaultResponse<InvoiceDTO>> save(
  ...
  ResponseEntity<DefaultResponse<InvoiceDTO>> update(
      @Valid @NotNull @RequestBody InvoiceDTO invoiceDTO, BindingResult bindingResult);

  @ApiOperation(
      value = "Delete invoice by ID",
  ...
  @ApiOperation(
      value = "Find invoice content by ID",
  ...
  @ApiOperation(
      value = "Save content for invoice by ID",
  ...
  @PostMapping(
      value = "/invoice/{id}/content",
      consumes = MediaType.MULTIPART_FORM_DATA_VALUE,
      produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
  ResponseEntity<DefaultResponse<InvoiceDTO>> saveContentByInvoiceId(
      @PathVariable("id") Integer id, @RequestParam("file") MultipartFile file);

  @ApiOperation(
      value = "Get next counter",
      notes = "Get next counter for Invoice",
      response = Integer.class)
  @ApiResponses(
      value = {@ApiResponse(code = 200, message = "Successful operation", response = String.class)})
  @GetMapping(value = "/invoice/counter", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
