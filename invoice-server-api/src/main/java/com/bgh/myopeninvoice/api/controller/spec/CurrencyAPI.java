...
public interface CurrencyAPI {
  ...
  ResponseEntity<DefaultResponse<CurrencyDTO>> findAll(
      @RequestParam Map<String, String> queryParameters);

  @ApiOperation(
      value = "Find currency by ID",
      notes = "Returns a list of CurrencyDTO",
      response = DefaultResponseCurrencyDTO.class)
  @ApiResponses(
      value = {
  ...
  ResponseEntity<DefaultResponse<CurrencyDTO>> save(
  ...
  ResponseEntity<DefaultResponse<CurrencyDTO>> update(
      @Valid @NotNull @RequestBody CurrencyDTO currencyDTO, BindingResult bindingResult);

  @ApiOperation(
      value = "Delete currency by ID",
  ...
  @ApiOperation(
      value = "Find currency content by ID",
  ...
  @ApiOperation(
      value = "Save content for currency by ID",
  ...
  @PostMapping(
      value = "/currency/{id}/content",
      consumes = MediaType.MULTIPART_FORM_DATA_VALUE,
      produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
  ResponseEntity<DefaultResponse<CurrencyDTO>> saveContentByCurrencyId(
